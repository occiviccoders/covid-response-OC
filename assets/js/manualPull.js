// If i miss a day
// Copy html from wayback machine and past into oldHtml/oldHtml.html
// remove all script elements from head
// run 'npm run manual'
// edit the correct date in db
// push - run npm write and npm run push
...
const fetchData = async (url) => {
    ...
    const $ = cheerio.load(fs.readFileSync('assets/oldHtml/oldHtml.html'));
